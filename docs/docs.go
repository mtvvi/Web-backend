...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/building-types": {
            "get": {
                "description": "Возвращает список типов зданий с возможностью поиска (публичный доступ)",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/api/estimates": {
            "get": {
                ...
                "description": "Возвращает список заявок с фильтрацией по ролям (пользователь видит только свои, модератор - все)\nВозвращает список заявок: для пользователей - только свои, для модераторов - все",
                "produces": [
                    "application/json",
                    "application/json"
                ],
